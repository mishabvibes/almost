  ...
  useEffect(() => {
    const fetchInstitutionDetails = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(`Failed to fetch institution details: ${response.status}`);
        }
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border-l-4 border-blue-500">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">From {sortedAndFilteredDonations.length} filtered results</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border-l-4 border-green-500">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{formatCurrency(totalCompletedAmount)} completed</p>
            </div>
                    ...
                    <>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6">
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatCurrency(selectedDonation.amount)}</p>
                          </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div className="space-y-4">
                          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Donor Information</h4>
                          ...
                          <div>
                            ...
                            <div className="flex items-center justify-between bg-gray-50 dark:bg-gray-700 p-2 rounded-lg">
                              <span className="text-gray-900 dark:text-white">{selectedDonation.email || 'Not provided'}</span>
                        ...
                        {/* Payment Information */}
                        <div className="space-y-4">
                          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Payment Information</h4>
                            ...
                            <div className="flex items-center justify-between bg-gray-50 dark:bg-gray-700 p-2 rounded-lg">
                              ...
                              {selectedDonation.razorpayPaymentId && (
                                <button 
                                  ...
                                  title="Copy to clipboard"
                                >
                                  {copiedField === 'paymentId' ? <Check className="h-4 w-4 text-green-500" /> : <Copy className="h-4 w-4" />}
                                </button>
                              )}
                            </div>
                          </div>
                            ...
                            <div className="flex items-center justify-between bg-gray-50 dark:bg-gray-700 p-2 rounded-lg">
                              ...
                              {selectedDonation.razorpayOrderId && (
                                <button 
                                  ...
                                  title="Copy to clipboard"
                                >
                                  {copiedField === 'orderId' ? <Check className="h-4 w-4 text-green-500" /> : <Copy className="h-4 w-4" />}
                                </button>
                              )}
                            </div>
                          </div>
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Donation Type</label>
                      ...
                      <div className="space-y-4">
                        <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Location Information</h4>
